...
uint16 FRoadMapPixelData::EncodeNew(bool IsRoad, bool HasDirection, const FVector &Direction, const int32 RoadLaneIndex)
{
	...
	return (IsRoad << IsRoadRow) | (HasDirection << HasDirectionRow) | RoadLaneIndex << RoadLaneIndexLowBit | (AngleAsUInt);
}
uint16 FRoadMapPixelData::Encode(bool IsRoad, bool HasDirection, const FVector &Direction, uint16 RoadLaneIndex)
{
  const uint16 AngleAsUInt = MaximumEncodedAngle * GetRotatedAzimuthAngle(Direction) / (2.0f * PI);
  check(!(AngleAsUInt & (1 << IsRoadRow)));
  check(!(AngleAsUInt & (1 << HasDirectionRow)));
    ...
    const bool bInvertDirection)
{
  ...
  switch (Tag) {
    ...
    case ECityMapMeshTag::RoadXIntersection_Lane9:
		...
		Rotator.Yaw += 180.0f;
		break;
	case ECityMapMeshTag::Road90DegTurn_Lane1_Add1:
		RoadLaneIndex = 1;
		bIsRoad = true;
		bHasDirection = true;
		Rotator.Yaw += 180.0f;
		break;
	case ECityMapMeshTag::RoadTwoLanes_LaneRight_AddLaneRight_0:
		RoadLaneIndex = 1;
		bIsRoad = true;
		bHasDirection = true;
		Rotator.Yaw += 180.0f;
		break;
	case ECityMapMeshTag::RoadTwoLanes_LaneRight_AddLaneRight_1:
		RoadLaneIndex = 2;
		bIsRoad = true;
		bHasDirection = true;
		Rotator.Yaw += 180.0f;
		break;
	case ECityMapMeshTag::RoadTwoLanes_LaneRight_AddLaneRight_2:
	  RoadLaneIndex = 3;
      bIsRoad = true;
      bHasDirection = true;
      Rotator.Yaw += 180.0f;
    ...
    case ECityMapMeshTag::RoadXIntersection_Lane8:
		...
		bHasDirection = true;
		break;
	case ECityMapMeshTag::Road90DegTurn_Lane0_Add0:
		RoadLaneIndex = 1;
		bIsRoad = true;
		bHasDirection = true;
		break;
	case ECityMapMeshTag::RoadTwoLanes_LaneLeft_AddLaneLeft_0:
		RoadLaneIndex = 1;
		bIsRoad = true;
		bHasDirection = true;
		break;
	case ECityMapMeshTag::RoadTwoLanes_LaneLeft_AddLaneLeft_1:
		RoadLaneIndex = 2;
		bIsRoad = true;
		bHasDirection = true;
		break;
	case ECityMapMeshTag::RoadTwoLanes_LaneLeft_AddLaneLeft_2:
		RoadLaneIndex = 3;
		bIsRoad = true;
		bHasDirection = true;
		break;
    ...
    case ECityMapMeshTag::RoadXIntersection_Lane5:
      ...
      Rotator.Yaw += 90.0f;
      break;
	case ECityMapMeshTag::Road90DegTurn_Lane9_Add9:
	  RoadLaneIndex = 1;
	  bIsRoad = true;
	  bHasDirection = true;
	  Rotator.Yaw += 90.0f;
    ...
    case ECityMapMeshTag::Road90DegTurn_Lane7:
	  ...
	  break;
	case ECityMapMeshTag::Road90DegTurn_Lane7_Add7:
	  RoadLaneIndex = 1;
	  bIsRoad = true;
	  bHasDirection = true;
	  Rotator.Yaw += 90.0f; //+ 15.5f;
    ...
    case ECityMapMeshTag::Road90DegTurn_Lane5:
      ...
      break;
	case ECityMapMeshTag::Road90DegTurn_Lane5_Add5:
	  RoadLaneIndex = 1;
	  bIsRoad = true;
	  bHasDirection = true;
	  Rotator.Yaw += 90.0f + 35.0f;
    ...
    case ECityMapMeshTag::Road90DegTurn_Lane3:
      ...
      break;
	case ECityMapMeshTag::Road90DegTurn_Lane3_Add3:
	  RoadLaneIndex = 1;
	  bIsRoad = true;
	  bHasDirection = true;
	  Rotator.Yaw += 90.0f + 45.0f + 20.5f;
    ...
    case ECityMapMeshTag::RoadXIntersection_Lane4:
      ...
      Rotator.Yaw += 270.0f;
      break;
	case ECityMapMeshTag::Road90DegTurn_Lane8_Add8:
	  RoadLaneIndex = 1;
	  bIsRoad = true;
	  bHasDirection = true;
	  Rotator.Yaw += 270.0f;
    ...
    case ECityMapMeshTag::Road90DegTurn_Lane6:
	  ...
	  break;
	case ECityMapMeshTag::Road90DegTurn_Lane6_Add6:
	  RoadLaneIndex = 1;
	  bIsRoad = true;
	  bHasDirection = true;
	  Rotator.Yaw += 270.0f + 50.0f;
    ...
    case ECityMapMeshTag::Road90DegTurn_Lane4:
	  ...
	  break;
	case ECityMapMeshTag::Road90DegTurn_Lane4_Add4:
	  RoadLaneIndex = 1;
	  bIsRoad = true;
	  bHasDirection = true;
	  Rotator.Yaw += 270.0f + 80.0f;
    ...
    case ECityMapMeshTag::Road90DegTurn_Lane2:
      ...
      break;
	case ECityMapMeshTag::Road90DegTurn_Lane2_Add2:
	  RoadLaneIndex = 1;
	  bIsRoad = true;
	  bHasDirection = true;
	  //Rotator.Yaw += 270.0f + 70.0f;
	...
	case ECityMapMeshTag::RoadTIntersection_Lane_sub:
      bIsRoad = true;
      bHasDirection = false;
      break;
  }
  ...
  const auto Value = FRoadMapPixelData::Encode(bIsRoad, bHasDirection, Direction, RoadLaneIndex);
  RoadMapData[GetIndex(PixelX, PixelY)] = Value;
}

void URoadMap::SetNewPixelAt(
	int32 PixelX,
	int32 PixelY,
	bool bHasDirection,
	bool bIsRoad,
	...
	int32 RoadLaneIndex)
{
	const auto Value = FRoadMapPixelData::EncodeNew(bIsRoad, bHasDirection, Direction, RoadLaneIndex);
	RoadMapData[GetIndex(PixelX, PixelY)] = Value;
}
